...
// Small toolbar menus render into a body-level portal at a viewport-clamped
// fixed position, rather than a plain `absolute` child - the toolbar sits in
// a narrow, overflow-hidden pane, and an absolute menu gets sliced off by
// that pane's edge instead of just running out of window.
function useMenuPortalStyle(open: boolean, container: React.RefObject<HTMLDivElement | null>, width: number): React.CSSProperties {
